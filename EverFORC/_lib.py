...
def generate_FORC_sequence(
  ...
  f.write(f'VSMCM "Measure sweep hysteresis"\n')
  f.write(f'VSMMH 1 36208647 0 0 0 2 40 1 0 2 0 1 6 {-saturation_field} 0 {saturation_field} 25 1 25 50 0 2 0 0 1 0 "A/C,0,10,10,0" "Q/M,0," \n')
  ...
  for i in range(1, N + 1):
    ...
    f.write(f'VSMMH 1 36208647 0 1 0 2 40 1 0 2 0 1 2 -90000 {min_field} {saturation_field} 25 0 2 {field_step} 0 1 0 0 1 0 "A/C,0,10,10,0" "Q/M,0," \n')
    count_lines += 2
